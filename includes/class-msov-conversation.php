...
if ( ! class_exists( 'MSOV_conversation' ) ) {
    class MSOV_conversation{
        static function init() {
            ...
            add_action( 'wp_footer', __CLASS__ . '::mshop_footertrack_code', 1 );
            ...
            if( self::conversation_track_enabled()){
                ...
                if ( ! empty( $content_ids ) ) {
                    ...
                    foreach ( $content_ids as $content_id ) {
                        ...
                        if ( ! empty( $content_id['track_service'] ) && ! empty( $content_id['track_content'] ) && ($content_id['track_service']=='naver') ) {
                            ob_start();
